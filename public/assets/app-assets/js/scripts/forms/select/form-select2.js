...
(function(window, document, $) {
  ...
  // Basic Select2 select
    ...
    function iconFormat(icon) {
        ...
        var $icon = "<i class='fas fa-" + $(icon.element).data('icon') + "'></i>" + icon.text;
    ...
    function formatRepo (repo) {
      ...
      markup += "<div class='select2-result-repository__statistics'>" +
        "<div class='select2-result-repository__forks'><i class='fas fa-code-branch mr-0'></i> " + repo.forks_count + " Forks</div>" +
        "<div class='select2-result-repository__stargazers'><i class='fas fa-star mr-0'></i> " + repo.stargazers_count + " Stars</div>" +
        "<div class='select2-result-repository__watchers'><i class='fas fa-eye mr-0'></i> " + repo.watchers_count + " Watchers</div>" +
      "</div>" +
      "</div></div>";
