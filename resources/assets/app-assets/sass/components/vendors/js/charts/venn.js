(function (global, factory) {
    ...
    /// Returns two r2as, one of the euclidean distances between the sets
    /// and the other indicating if there are subset or disjoint set relationships
    function getDistanceR2as(areas, sets, setids) {
    ...
    function constrainedMDSLayout(areas, params) {
        ...
        var r2as = getDistanceR2as(areas, sets, setids),
            distances = r2as.distances,
            constraints = r2as.constraints;
    ...
    function greedyLayout(areas) {
        ...
        // answer: probably not
        // var distances = venn.getDistanceR2as(circles, areas).distances;
